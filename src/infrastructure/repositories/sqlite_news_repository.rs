...
impl NewsRepository for SqliteNewsRepository {
    ...
    async fn find_by_domains(
        ...
        for (id, title, url, source, author, published_at, domain_str, confidence) in rows {
            let published_at =
                chrono::DateTime::parse_from_rfc3339(&published_at)?.with_timezone(&chrono::Utc);
...
mod tests {
    ...
    async fn test_find_recent() {
        ...
        let news_items = vec![
            NewsItem::new_with_classification(
                String::from("1"),
                String::from("Oldest"),
                String::from("https://example.com/1"),
                String::from("source"),
                String::from("author"),
            ...
            NewsItem::new_with_classification(
                String::from("2"),
                String::from("Middle"),
                String::from("https://example.com/2"),
                String::from("source"),
                String::from("author"),
            ...
            NewsItem::new_with_classification(
                String::from("3"),
                String::from("Newest"),
                String::from("https://example.com/3"),
                String::from("source"),
                String::from("author"),
                base_time,
                Domain::Social,
    ...
    async fn test_find_by_url() {
        ...
        let not_found = repo
            .find_by_url("https://example.com/notfound")
            .await
            .unwrap();
